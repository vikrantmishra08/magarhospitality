...
if($res['success']){
	...
	$body .="We have recorded the following \"Contact\" mail for you:<br /><br />";
	...
	$subject="Contact Request from MCRPL Website";
	...
	{
	$body="";
	$body .= "Dear ".trim(stripslashes($_REQUEST['name'])).", <br /><br />Your \"Contact\" mail has been successfully sent to site administrator. We will get back to you soon.<br /><br /> Following are your request details:<br /><br />";
